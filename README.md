...
**I use : Git, GitHub, Xilinx Vivado, ArduinoIDE, any JetBrains IDE(CLion and IntelliJ IDEA mainly), Vitis, Visual Studio Code, ASP.NET, Entity Framework, SpringBoot, OpenGL, OpenCV.**
...
- [Polish Trains Delays](https://github.com/4lac1vica/PolishTrainsDelaysML) --> Project for Intelligent Systems Class 
